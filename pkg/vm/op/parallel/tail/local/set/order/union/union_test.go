...
func TestUnion(t *testing.T) {
	...
	{
		n := New(newOrder0(), newOrder1(), testContext.New(1, 1, 1024*1024*1024, 1024*1024*1024*1024))
		{
			fmt.Printf("%s\n", n)
		}
		{
...
func newOrder0() op.OP {
	return order.New(newRestrict0(), []bool{true}, []string{"a"}, testContext.New(1, 1, 1024*1024*1024, 1024*1024*1024*1024))
}

func newOrder1() op.OP {
	return order.New(newRelation1(), []bool{true}, []string{"a"}, testContext.New(1, 1, 1024*1024*1024, 1024*1024*1024*1024))
}
