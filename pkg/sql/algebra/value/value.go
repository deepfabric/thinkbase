...
func GetInt(v Value) (Int, error) {
	...
	return 0, fmt.Errorf("cannot convert %s to type %s", v.ResolvedType(), types.Bool)
}
...
func GetString(v Value) (String, error) {
	...
	return "", fmt.Errorf("cannot convert %s to type %s", v.ResolvedType(), types.Bool)
}
...
func GetTime(v Value) (Time, error) {
	...
	return Time{}, fmt.Errorf("cannot convert %s to type %s", v.ResolvedType(), types.Bool)
}
...
func (_ Table) Compare(_ Value) int    { return 0 }
func (_ Table) String() string         { return "table" }
func (_ Table) ResolvedType() *types.T { return types.Table }
